...
Task: Using the provided title and challenges, explain how can the user A person who is in need of aid can get help from this issues and be more proactive in avoiding them. Keep it actionable and empathetic.

Title: ${title || 'Community Need'}
Challenges:
${bullets}

1. Start with a brief empathetic acknowledgment of the challenges.
2. Provide 3-5 actionable steps the user can take to get help or support their community.
...
export default GeminiNeedsHelp;